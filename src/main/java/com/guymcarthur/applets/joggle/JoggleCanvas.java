...
public class JoggleCanvas extends Canvas implements Debuggable {
   ...
   */
  public JoggleCanvas(JoggleBoard board, Hashtable images) {
    this.board=board;
    this.images=images;
    ...
    if(debug) System.out.println("Preferred size = "+getPreferredSize());
  }
  ...
  public Dimension getMinimumSize() {
    Image image=(Image)(images.elements().nextElement());
    return new Dimension(board.rows*image.getWidth(this),
			 board.cols*image.getHeight(this));
  }
